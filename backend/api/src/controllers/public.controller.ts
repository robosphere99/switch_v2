...
export function downloadApk(_req: Request, res: Response): void {
...
export async function verifyBill(req: Request, res: Response): Promise<void> {
...
// Assistant FAQ and Suggestion helper logic
...
export async function publicAssistant(req: Request, res: Response): Promise<void> {
...
export async function adminAssistant(req: Request, res: Response): Promise<void> {
  if (req.user!.role !== "system_admin") {
...
export async function postContactForm(req: Request, res: Response): Promise<void> {
  ...
  if (!name) { ok(res, { error: "Name required" }, 400); return; }
  if (!message) { ok(res, { error: "Message required" }, 400); return; }
  if (message.length > 4000) { ok(res, { error: "Message 4000 chars se kam rakho" }, 400); return; }
...
export async function getMySupport(req: Request, res: Response): Promise<void> {
...
export async function postSupportMessage(req: Request, res: Response): Promise<void> {
