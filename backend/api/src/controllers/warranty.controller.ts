...
export async function getWarrantyStatus(req: Request, res: Response): Promise<void> {
...
export async function fileWarrantyClaim(req: Request, res: Response): Promise<void> {
...
export async function getMyWarranty(req: Request, res: Response): Promise<void> {
